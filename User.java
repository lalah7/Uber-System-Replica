...
public class User 
{
  ...
  {
    if (!(other instanceof User)){// check if other is instance of this class
      return false;
    }

    User otherUser = (User) other;//cast other to a User variable

    if (this.name.equals(otherUser.name) && this.address.equals(otherUser.address)){//check if if they have the same name and address.
      return true;
    }
    return false;
  }
